...
class Home extends Model{
	...
	function __construct($loggedin,$pageTitle,$pageHead){   
        ...
        public function setPanelHead_1(){//set the panel 1 heading
                $this->panelHead_1='<h3>College Online System</h3>';
        }//end METHOD - //set the panel 1 heading
        public function setPanelContent_1(){//set the panel 1 content
            if($this->loggedin){
                $this->panelContent_1='<h4>Overview</h4>';
                $this->panelContent_1.='<p>College online system is designed for lecturers to manage their modules, classes and student grades.'; 
        ...
        public function setPanelContent_2(){//set the panel 2 content
            ...
            if($this->loggedin){
                $this->panelContent_2='Thank you for logging in successfully to the College Online System. Please use the links above to manage your modules, students and grades. <br><br>Don\'t forget to logout when you are done.';
            }
            else{        
        ...
        public function setPanelHead_3(){ //set the panel 3 heading
            if($this->loggedin){
                $this->panelHead_3='<h3>College Online</h3>';
            }
            else{        
                $this->panelHead_3='<h3>College Online</h3>';
            } 
        ...
        public function setPanelContent_3(){ //set the panel 2 content
            if($this->loggedin){
                $this->panelContent_3='';
                $this->panelContent_3.='<p>Logged on to College Online System</p>'; 
            }
            else{        
                $this->panelContent_3='';
